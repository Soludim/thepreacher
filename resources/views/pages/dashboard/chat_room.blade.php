...
<script>
    ...
    $(document).ready(function() {
        ...
        function sendMsg(payload) {
            $.ajax({
                    type: "post",
                    url: `${apiUrl}/chat_room`, // route to save message
                    data: payload,
        ...
        function getMsgs() {
            $.ajax({
                type: "get",
                url: `${apiUrl}/api/chat/${group_id}?api_token=${token}`,
                data: "",
                cache: false,
                success: function(data) {
    ...
    function getData() {
        $.ajax({
            url: `${apiUrl}/api/user?page=${page}&username=${search}`,
            type: 'get',
            success: function(data) {
                $('#modal_ul').html(null);
    ...
    $('#modal_ul').on('click', '.toggle', function() {
        ...
        $.ajax({
            url: `${apiUrl}/api/chat_user?api_token=${token}`,
            type: 'post',
            data: {
                'chat_id': group_id,
                'user_id': userId,
    ...
    $('.modal-footer').on('click', '#done_btn', function() {
        ...
        $.ajax({
            url: `${apiUrl}/api/chat/${group_id}/user?api_token=${token}`,
            type: 'get',
            success: function(data) {
