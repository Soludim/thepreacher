    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-10 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                <p class="breadcrumbs mb-2" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="/">Home</a> <span>Event</span></p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 ftco-animate">
                ...
                <p>Posted on: {{date('F', strtotime($data->event->created_at))}} {{date('d', strtotime($data->event->created_at)) }}, {{ date('Y', strtotime($data->event->created_at)) }}</p>
            </div>
