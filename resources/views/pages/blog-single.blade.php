                ...
                <div class="sidebar-box ftco-animate">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        ...
                        <div class="text">
                            ...
                            <div class="meta">
                                <div><span class="icon-calendar"></span> {{date('M', strtotime($post->created_at))}} {{date('d', strtotime($post->created_at)) }}, {{ date('y', strtotime($post->created_at)) }}</div>
